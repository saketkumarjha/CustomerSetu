...
export function Header({ sidebarOpen, onMenuToggle }: Props) {
  return (
    <header className="flex items-center justify-between px-4 md:px-6 py-2.5 bg-ub-blue shadow-lg flex-shrink-0 z-30">
      <div className="flex items-center gap-3">
        {/* Hamburger — mobile only */}
        <button
          onClick={onMenuToggle}
          className="lg:hidden w-9 h-9 rounded-md flex items-center justify-center text-white hover:bg-white/10 transition-colors flex-shrink-0"
        ...
        <div className="bg-white rounded-md px-2.5 py-1 flex items-center flex-shrink-0">
          <img
            src="/logo.jpeg"
        ...
        {/* Live badge — md+ only */}
        <div className="hidden md:flex items-center gap-2 ml-1 px-3 py-1 rounded-md text-xs bg-white/10 text-blue-100 border border-white/10 flex-shrink-0">
      ...
      <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
        ...
        <div className="relative cursor-pointer">
          <div className="w-9 h-9 rounded-md flex items-center justify-center text-white hover:bg-white/10 transition-colors">
            <Bell size={18} />
          </div>
